...
<body>
        ...
        <div class="container-fluid">
            ...
            <div class="collapse navbar-collapse" id="navbarSupportedContent">
                <ul class="navbar-nav ms-auto mb-2 mb-lg-0">
                    ...
                    <li class="nav-item">
                        <a class="nav-link active" aria-current="page" href="#ass">Conocenos</a>
                    </li>
                </ul>
            </div>
        </div>
    ...
    <header> <!--fondo de pantalla-->
        <!--   codig cup      <h1 id="titulo">ICPC</h1>-->
    </header>
    ...
    <div class="d-flex justify-content-center align-items-center" border-dark style="min-height: 35vh;">
        <div class="card m-1" style="max-width: 740px;">
          <div class="row g-0">
            ...
            <div class="col-md-8">
              <div class="card-body">
                <h3 class="card-title text-center">¿Concursos de competicion?</h3>
                <p class="card-text">Lorem ipsum dolor sit amet consectetur adipisicing elit. Omnis, iste aliquid 
                    praesentium placeat modi doloremque consequuntur ad labore repellendus natus expedita excepturi provident 
                    est impedit officiis quo et fugit cupiditate.
                    Lorem ipsum dolor sit amet consectetur adipisicing elit. Ullam, velit nihil explicabo incidunt eius doloremque
                    nobis tenetur asperiores est? Totam ad cupiditate eaque corporis illo laboriosam architecto est, iure ex?
                </p>
              </div>
            </div>
          </div>
      ...
      <div class="d-flex justify-content-center align-items-center" id="cuadro" style="min-height: 20vh;">
        <div class="card text-center">
            <h5 class="card-title">Vamos a comenzar una competicion</h5>
          <a class="card-text">Comenzaremos hacer el registro para que comienze este</a>
          <a class="card-text">a competir con nueva gente y tener nuevos desafios</a>
         <div>
            <a href="IniciarSesion.php" class="btn btn-primary">Iniciar sesion</a>
            <a  href="Registrar.php" class="btn btn-primary">Registrarte</a>
         </div>
        </div>
    </div>
    ...
    <div class="acc">
        ...
        <p class="text-center" id="AccercaDel" >Lorem ipsum dolor sit amet consectetur adipisicing elit.
            Cupiditate accusamus ut aperiam pariatur fuga at, impedit magnam obcaecati numquam provident iure sint? Earatione nemo voluptas velit, perferendis blanditiis? Reiciendis.</p>
        <br>        
    </div>
